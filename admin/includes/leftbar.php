...
<li><a href="#"><i class="fa fa-files-o"></i> Furniture Categories</a>
<ul>
<li><a href="add-bloodgroup.php">Add Furniture Category</a></li>
<li><a href="manage-bloodgroup.php">Manage Furniture Categories</a></li>
</ul>
</li>


				<li><a href="add-donor.php"><i class="fa fa-edit"></i> Add User</a></li>
